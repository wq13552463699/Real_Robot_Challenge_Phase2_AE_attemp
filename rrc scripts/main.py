...
from rrc_example_package.scripts.env import GymEnv, EnvBatcher
from rrc_example_package.scripts.memory import ExperienceReplay
from rrc_example_package.scripts.models import bottle, Encoder, ObservationModel, RewardModel, TransitionModel
from rrc_example_package.scripts.planner import MPCPlanner
from rrc_example_package.scripts.utils import lineplot, write_video
import time
...
parser.add_argument('--embedding-size', type=int, default=2048, metavar='E', help='Observation embedding size')  # Note that the default encoder for visual observations outputs a 1024D vector; for other embedding sizes an additional fully-connected layer is used
...
parser.add_argument('--chunk-size', type=int, default=100, metavar='L', help='Chunk size')

# parser.add_argument('--chunk-size', type=int, default=50, metavar='L', help='Chunk size')
parser.add_argument('--overshooting-distance', type=int, default=80, metavar='D', help='Latent overshooting distance/latent overshooting weight for t = 1')
